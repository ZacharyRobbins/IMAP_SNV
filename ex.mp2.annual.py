...
nameofthing='IMAP_SNV_SA.IELMFATES'
...
var=["RAIN",'BTRAN','FATES_NPP','IMAP_Larvae_1','IMAP_Larvae_2', 'IMAP_Pupae','IMAP_Insect_Population','IMAP_Tadult','IMAP_Eggs','FATES_LAI_AP','FATES_STOREC','FATES_STOMATAL_COND',"FATES_VEGC_ABOVEGROUND",'FATES_VEGC']
