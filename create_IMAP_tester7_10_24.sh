...
# CREATE THE CASE
/lustre/scratch5/.mdt1/${user}/ACME_2023/E3SM/cime/scripts/create_newcase -case ${CASEROOT}/${CASE_NAME} -res ${RES} -compset ${COMPSET} -mach ${MAC} -project ${FUNDING} -compiler ${COMPILER} -mpilib="mpi-serial"
