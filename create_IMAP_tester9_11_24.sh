...
export TAG='IMAP_SNV_SA'                               # User defined tag to differentiate runs
...
export DIN_LOC_ROOT_FORCE=${DATA_DIR}/  #location of climate forcing, not including the SITE_NAMES
...
fates_inventory_ctrl_filename = '${CLM_SURFDAT_DIR}/Sierra_inv_file2.txt'
use_fates_insect = .true.
...
`sed -i '/CLM1PT_data/eglin_0.1x0.1_met.v2pio/' user_datm.streams.txt.CLM1PT.ELM_USRDAT`
