...
var=["FATES_VEGC_ABOVEGROUND",'FATES_VEGC','FATES_GPP','QVEGE','QVEGT','QSOIL']
...
print(wdir+"/run/"+nameofthing+".elm.h0."+str(args.Yeare)+"-01.nc")
if path.exists(wdir+"/run/"+nameofthing+".elm.h0."+str(args.Yeare)+"-01.nc")==True:
	for Year in Yearset:
		Year=str(Year)
		print(Year)
		for month in Monthset:
		        #print(month)
			data_path=wdir+"/run/"+nameofthing+".elm.h0."+Year+"-"+month+".nc"
			print(data_path)
