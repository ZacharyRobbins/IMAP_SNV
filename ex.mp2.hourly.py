...
#nameofthing='LFM_PIPO_Sens'
#outputfolder="LFM_testing_sens"
#root='/lustre/scratch5/ltiede/E3SM_run/scratch/'
#nameofthing='BCI_ml'
#outputfolder="BCI_ml_output"
root='/lustre/scratch5/zjrobbins/E3SM/scratch/'
nameofthing='IMAPtester2'
